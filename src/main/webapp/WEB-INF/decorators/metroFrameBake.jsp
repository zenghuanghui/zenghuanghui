                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%= path%>/metronic/assets/layouts/img/avatar2.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%= path%>/metronic/assets/layouts/img/avatar3.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%= path%>/metronic/assets/layouts/img/avatar1.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar3.jpg" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar1.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar4.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar2.jpg" alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar6.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar7.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar8.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar9.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar10.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<%= path%>/metronic/assets/layouts/img/avatar11.jpg" alt="...">
                                <div class="media-body">
                    ...
                    <div class="page-quick-sidebar-item">
                        <div class="page-quick-sidebar-chat-user">
                            ...
                            <div class="page-quick-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt="" src="<%= path%>/metronic/assets/layouts/img/avatar3.jpg" />
                                    <div class="message">
                                        <span class="arrow"></span>
                                ...
                                <div class="post in">
                                    <img class="avatar" alt="" src="<%= path%>/metronic/assets/layouts/img/avatar2.jpg" />
                                    <div class="message">
                                        <span class="arrow"></span>
...
<script src="<%= path%>/metronic/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
...
<script src="<%= path%>/metronic/assets/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
...
<script src="<%= path%>/metronic/assets/layouts/scripts/quick-sidebar.min.js" type="text/javascript"></script>
</body>
</html>
